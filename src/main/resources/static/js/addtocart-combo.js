document.addEventListener("DOMContentLoaded", function() {
    ...
    const productQuantityInputs = document.querySelectorAll(".product_quantity");
    ...
    function handleAddToCart(event) {
        ...
        const productQuantityInput = addToCartBtn.closest(".single_combo_slider").querySelector(".product_quantity");
        const productName = addToCartBtn.closest(".single_combo_slider").querySelector(".product_name").textContent;
        const productPrice = parsePrice(addToCartBtn.closest(".single_combo_slider").querySelector(".product_price").textContent); // Convert price to number
        const productQuantity = parseInt(productQuantityInput.value);
        const productImage = addToCartBtn.closest(".single_combo_slider").querySelector(".s_product_img img").src;
